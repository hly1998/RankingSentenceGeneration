...
from posttraining.teachers import Teacher
...
class CLTrainer(Trainer):
    ...
    def train(self, model_path: Optional[str] = None, trial: Union["optuna.Trial", Dict[str, Any]] = None):
        ...
        teacher = None
        first_pooler = "cls_before_pooler"
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                with torch.no_grad():
                    ...
                    first_teacher_z1, first_teacher_z2 = embeddings1, embeddings1
                    ...
                    inputs["teacher_top1_sim_pred"] = first_teacher_top1_sim
        ...
        if self.args.load_best_model_at_end and self.state.best_model_checkpoint is not None:
            ...
            if isinstance(self.model, PreTrainedModel):
                # print("the best model path:", self.state.best_model_checkpoint)
